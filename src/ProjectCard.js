...
export const ProjectCard = ({project, project: {screenshot, title, description, pillsFe, pillsBe, siteUrl, githubUrl}}) => {
    ...
    return <Fade><div className="p-10 m-10 bg-stone-700 rounded-2xl flex">
        <div className="block basis-2/5 shrink-0">
            <img
                src={screenshot}
        ...
        <div className="pl-20">
            ...
            <div className='flex'>
                ...
                {githubUrl && <a href={githubUrl} target='_blank' rel="noreferrer" className='text-stone-300 hover:text-stone-200 hover:underline inline-flex items-center'>
                    <svg xmlns="http://www.w3.org/2000/svg"
                         viewBox="0 0 496 512"
                         className="w-5 h-5 mr-2 inline-block"
                    >
