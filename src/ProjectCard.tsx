...
export function ProjectCard({
  ...
  const siteUrls = Array.isArray(siteUrl) ? siteUrl : [siteUrl];
  const githubUrls = Array.isArray(githubUrl) ? githubUrl : [githubUrl];
  ...
  return (
    <div className="p-5 xl:p-10 m-5 xl:m-10 bg-stone-700 rounded-2xl flex snap-center xl:height=[80vh] flex-wrap xl:flex-nowrap">
      ...
      <div className="xl:pl-20">
        ...
        {description.map((p, i) => (
          <p key={i} className="text-stone-400 mb-4 last:mb-0">
            {p}
          </p>
        ))}
        <div className="my-5">
          ...
          <div className="flex flex-col gap-5">
            {siteUrls.map((url) => (
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="shrink-0 text-stone-300 hover:text-stone-200 hover:underline mr-10"
              >
                <svg
          ...
          <div className="flex flex-col gap-5">
            {githubUrls.map((url) => (
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="text-stone-300 hover:text-stone-200 hover:underline inline-flex items-center"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 496 512"
