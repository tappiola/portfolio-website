    ...
    const renderImages = () => {
        if (index === 1){
            return <>
                ...
                <img src={img[1]} className='hidden xl:block grayscale-[30%] rounded relative -top-24 -right-40 shadow-lg w-3/4'
                     alt="skill"/>
            </>
        }
        ...
        if (index === 2){
            return <>
                ...
                <img src={img[1]} className=' hidden xl:block grayscale-[30%] rounded relative -top-12 -right-40 shadow-lg w-3/4 z-10'
                     alt="skill"/>
            </>
        }
        ...
        if (index === 4){
            return <>
                <img src={img[0]} className='grayscale-[30%] rounded relative shadow-lg xl:w-3/4' alt="skill"/>
                <img src={img[1]} className='hidden xl:block grayscale-[30%] rounded relative -top-14 -right-36 shadow-lg w-3/4 z-10'
                     alt="skill"/>
            </>
        }
