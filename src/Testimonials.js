    ...
    return <div className={`carousel-item relative float-left w-full ${active ? 'active': ''}`}>
        <div className="flex flex-wrap justify-center">
            <div className="grow-0 shrink-0 basis-auto w-full lg:w-8/12 px-3">
                <h5 className="text-lg font-bold mb-3 text-stone-300">Maria Kate</h5>
                <p className="font-medium mb-4 text-stone-400">Scandiweb</p>
    ...
    return <section ref={ref} id='testimonials' className="container my-24 px-6 mx-auto h-full snap-center pt-20 -mt-20">
        ...
        <section className="mb-32 text-gray-800 text-center">
            ...
            <div id="carouselExampleCaptions" className="carousel slide relative carousel-dark" data-bs-ride="carousel">
                ...
                <button
                    className="fill-stone-400 carousel-control-next absolute top-0 bottom-0 flex items-center justify-center p-0 text-center border-0 hover:outline-none hover:no-underline focus:outline-none focus:no-underline right-0"
